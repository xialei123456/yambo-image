...
# 二、Yambo源码下载与编译安装
## 1. 下载并解压Yambo.5.3.0源码,这里我们以/home为例
cd /home
...
./configure
make all
###如果make过程中对依赖库的git下载遇到问题，可以手动下载并将其解压至external下的相应目录内，然后再次make all
...
###命令可以参考上面三行,逐一解压后make all，重复操作几次即可
